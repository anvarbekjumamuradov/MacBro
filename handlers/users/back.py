...
async def go_to_cats_menu(message: types.Message):
    await message.answer(f"<i>Gadjetlarga o'tish uchun sahifani tanlang...</i>", reply_markup=cats_markup, parse_mode="html")
...
async def go_to_products_menu(message: types.Message, state: FSMContext):
    ...
    await message.answer("Batafsil ma'lumot uchun gadjetni tanlang...", reply_markup=markup)
